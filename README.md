...
3. __Identify the minimal representation of UI state__ So what you learned so far from step 2 is only state change triggers re-render of your view. Some tips Identifying what data to make just model and what to make as states: 
