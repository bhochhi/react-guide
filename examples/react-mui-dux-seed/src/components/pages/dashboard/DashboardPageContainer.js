...
import {
  ...
  CartesianGrid,
  Tooltip,
  Legend,BarChart, Bar, Brush, ReferenceLine,PieChart, Pie, Sector,	ResponsiveContainer,RadialBarChart, RadialBar,
  ComposedChart,Area
} from 'recharts';
...
const dataLineBarAreaComposedChart = [{name: 'Page A', uv: 590, pv: 800, amt: 1400},
...
const LineBarAreaComposedChart = React.createClass({
	render () {
  	return (
        ...
        height={400} data={dataLineBarAreaComposedChart}
...
const SimpleRadialBarChart = React.createClass({
	render () {
  	return (
    	<RadialBarChart width={700} height={400} cx={350} cy={250} innerRadius={20} outerRadius={140} barSize={10} data={dataRadial}>
        <RadialBar minAngle={15} label background clockWise={true} dataKey='uv'/>
        <Legend iconSize={10} width={120} height={140} layout='vertical' verticalAlign='bottom' wrapperStyle={style}/>
        </RadialBarChart>
    );
  }
})
